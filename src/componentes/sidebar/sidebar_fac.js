  ...
  return (
    ...
    >
      ...
      <Nav className="flex-column">
        <Button variant="outline-light" className="mb-3 w-100 d-flex align-items-center" onClick={() => navigate('/main_facultad')}>
          <FaHome className="icon" style={{ minWidth: '30px' }} />
          {!isCollapsed && <span>Inicio</span>}
        </Button>

        <Button variant="outline-light" className="mb-3 w-100 d-flex align-items-center" onClick={() => navigate('/consejo_fac')}>
